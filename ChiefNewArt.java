...
public class ChiefNewArt {
	...
	private void initialize() {
		...
		frame.setTitle("Editor In Chief");
		frame.getContentPane().setBackground(Color.DARK_GRAY);
		frame.setBounds(100, 100, 451, 474);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(title.isEmpty()) {
					JOptionPane.showMessageDialog(frame, "Title is empty!","Inane warning",JOptionPane.WARNING_MESSAGE);
					frame.dispose();
				...
				if(path !=null &&  path.length()!=0 && path.charAt(0) == 'C' && path.charAt(1) == ':' && path.charAt(2) == '\\' ) {
					...
					for (String m : images) {
						if(m ==null || m.length() == 0) {
							...
							JOptionPane.showMessageDialog(frame, "Wrong image path input!","Inane warning",JOptionPane.WARNING_MESSAGE);
							return;
					...
					path = "";
					JOptionPane.showMessageDialog(frame, "Wrong article path input!","Inane warning",JOptionPane.WARNING_MESSAGE);
					return;
				}
				...
				window.frmChief.setVisible(true);
					...
					JOptionPane.showMessageDialog(frame, "Wrong input!","Inane warning",JOptionPane.WARNING_MESSAGE);
